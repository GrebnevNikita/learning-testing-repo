...
echo $class::CONSTANT."\n";
?>
Специальная константа ::class, которой на этапе
компиляции присваивается полное имя класса, полезна при использовании с классами, использующими пространства имён.
...
echo Foo1::BAR, PHP_EOL;
//echo Foo1::BAZ, PHP_EOL;
?>
